...
import com.pawa.ec.udomidrive_demo.provider.AuthProvider;
import com.pawa.ec.udomidrive_demo.provider.GeofireProvider;
...
public class UserLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Button btn_obtener_Udomi;
        ...
        public void onLocationResult(LocationResult locationResult) {
            for (Location location : locationResult.getLocations()) {
                if (getApplicationContext() != null) {
                    ...
                    // obtenemos nuestra localizacion, del usuario
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_obtener_Udomi = findViewById(R.id.btnRequestDriver);

        btn_location = findViewById(R.id.btn_geolocation);
        ...
        btn_obtener_Udomi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mOriginLatLng != null && mDestinationLatLng != null) {
                    Intent intent = new Intent(UserLocationActivity.this, RutaEscogidaActivity.class);
                    ...
                    Toast.makeText(UserLocationActivity.this, "Debe seleccionar el lugar de recogida y el destino", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void limitSearch() {
        // Damos informacion de donde tener referencia en nuestro caso ECUADOR
    ...
    private void instanceAutocompleteDestination() {
        ...
        mAutocompleteDestination.setHint("Ingrese su Destino");
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.moto)));
                marker.setTag(key);
            ...
            public void onKeyMoved(String key, GeoLocation location) {
                // Mos mostrara las posiciones lo los conductores
                for (Marker marker : mDriversMarkers) {
                    if (marker.getTag() != null) {
                        if (marker.getTag().equals(key)) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Buscara vehiculos a no mas de 5KM
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(UserLocationActivity.this, new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        })
                        .create()
                        .show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_update) {
            /*Intent intent = new Intent(MainActivitys.this, UpdateProfileActivity.class);
            startActivity(intent);*/
        }
        if (item.getItemId() == R.id.action_history) {
            /*Intent intent = new Intent(MainActivitys.this, HistoryBookingClientActivity.class);
            startActivity(intent);*/
        }
