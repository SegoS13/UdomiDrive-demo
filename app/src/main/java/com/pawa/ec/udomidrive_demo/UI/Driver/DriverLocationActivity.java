...
//import com.pawa.ec.udomidrive_demo.provider.TokenProvider;
...
public class DriverLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    //callback para escuchar cuando el usuario se mueva
    ...
    private void updateLocation() {
        // Validamos si el id se encuentra en sesion
    ...
    private void disconnect() {
        ...
        if (mFusedLocation != null) {
            ...
            //Eliminamos la posicion de la db si esque estamos en sesion
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(DriverLocationActivity.this, new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        })
                        .create()
                        .show();
    ...
    void logout() {
        ...
        Intent intent = new Intent(DriverLocationActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
