...
public class MainActivitys extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void onCameraMove() {
        mCameraListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                try {
                    Geocoder geocoder = new Geocoder(MainActivitys.this);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(MainActivitys.this, new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        })
                        .create()
                        .show();
    ...
    void logout() {
        ...
        Intent intent = new Intent(MainActivitys.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
